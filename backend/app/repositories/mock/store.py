...
class MockStore:
    users: dict[int, UserEntity] = {
        1: UserEntity(1, "han", "13800000000", mock_password(), "OWNER"),
        2: UserEntity(2, "member", "13900000000", mock_password(), "MEMBER"),
        3: UserEntity(3, "guest", "13700000000", mock_password(), "GUEST"),
        4: UserEntity(4, "maintainer", "13600000000", mock_password(), "MAINTAINER"),
    }
